...
<section class="col-md-10 col-md-offset-1" style=" padding: 0px; background: #fff; height: 500px; margin-top: 10px;">
  <a href="#"><button class="active btn">Solicitações Recebidas</button></a>
  <a href="cot_and.php"><button class="desativado btn">Cotações em Andamento</button></a>
  <a href="cot_con.php"><button class="desativado btn">Cotações Concluidas</button></a>
  <div class="col-md-12" style="height: 500px; border: 2px solid silver; overflow-x: hidden;">
      <br><h3 class="modal-title" align="center">SOLICITAÇÕES RECEBIDAS</h3>
      ...
      <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <td>--------</td>
            <td class='actions'>
                <a class='btn btn-success btn-xs'>Iniciar cotação</a>
