...
<footer class="mbr-section mbr-section--relative mbr-section--fixed-size" id="footer1-5" style="background-color: #fff; margin-top: 10px;">
        <button type="button" class="btn btn-inverse" aria-expanded="false" style="margin-left: 10px;">
            <b> SUBELEMENTO <span class="glyphicon glyphicon-remove-circle"></span></b>  
        </button>
</footer>
