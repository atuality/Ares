...
<section class="col-md-10 col-md-offset-1" style=" padding: 0px; background: #fff; height: 500px; margin-top: 10px;">
  ...
  <a href="empenho.php">
  		  <button class="active btn">Solicitação de Empenho</button>
  </a>
  <a href="liquidacao.php"><button class="desativado btn">Solicitação de Liquidação</button></a>
  <div class="col-md-12" style="height: 500px; border: 2px solid silver; overflow-x: hidden;">
      ...
      <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
              <div class="row">
                 ...
                 <div class="form-group col-md-3">
                     <label for="secretaria">Tipo de Empenho:</label>
                 ...
                 <div class="form-group col-md-3">
                     <label for="n_empenho">Fornecedor:</label>
                     <input type="text" class="form-control" id="solicitacao" name="solicitacao">
                 </div>
                 <div class="form-group col-md-3">
                     <label for="subelemento">Fonte de Recurso:</label>
                     <select class="form-control" name="subelemento" id="subelemento">
                        <option>--------</option>
                     </select>
                 </div>
                 ...
                 <div class="col-md-12">
                    <a href="../solic_emp" class="btn btn-primary col-md-12">NOVA SOLICITAÇÃO DE EMPENHO</a>
                 </div>
             </div>
             </div>
