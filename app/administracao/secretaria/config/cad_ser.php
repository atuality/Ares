...
<section id="menu" class="row">
    ...
    <div class="container-fluid">
      ...
      style="background: ; margin-top: 0px; height: 450px; padding: 0px;">
              <h3 align="center">Cadastrar Servidor</h3>
          <form style="margin-top: 10px;">
            <input type="text" name="nome" placeholder="Nome" class="input form-control" 
            required="required"><br>
            <input type="text" name="rg" placeholder="RG" class="input form-control" 
            required="required"><br>
            <input type="text" name="cpf" placeholder="CPF" class="input form-control" 
            required="required"><br>
